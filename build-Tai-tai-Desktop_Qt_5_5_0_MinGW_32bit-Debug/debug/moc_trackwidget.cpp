...
const QMetaObject TrackWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TrackWidget.data,
      qt_meta_data_TrackWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TrackWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TrackWidget.stringdata0))
        return static_cast<void*>(const_cast< TrackWidget*>(this));
